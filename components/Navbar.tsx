      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="hidden md:flex items-center">
            {appMode === "demo" ? (
              <div className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-violet-50 border border-violet-200 text-violet-700 font-extrabold text-[10px] tracking-wide animate-pulse">
                <Sparkles className="h-3 w-3" />
                <span>데모 시나리오</span>
              </div>
            ) : (
              <div className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-indigo-50 border border-indigo-200 text-indigo-750 text-indigo-700 font-extrabold text-[10px] tracking-wide">
                <CheckSquare className="h-3 w-3" />
                <span>실제 서비스 플로우</span>
              </div>
            )}
            ...
            <button
              ...
              className="ml-2 inline-flex items-center gap-1 px-2 py-1 rounded-lg border border-gray-200 bg-white text-gray-400 hover:text-gray-900 text-[10px] font-bold transition-all shadow-sm hover:border-gray-300"
        ...
        <nav className="flex items-center space-x-1 sm:space-x-2">
          ...
          <Link
            ...
            className={`flex items-center space-x-1 rounded-lg px-2.5 py-1.8 text-xs sm:text-sm font-semibold transition-all ${
          ...
          >
            ...
            <span className="hidden sm:inline">평가 요청 생성</span>
          </Link>
          ...
          >
            ...
            <span className="hidden sm:inline">데모 시나리오</span>
          </button>
          ...
          >
            ...
            <span className="hidden sm:inline">리포트 조회</span>
          </Link>
        </nav>
      </div>
    </header>
